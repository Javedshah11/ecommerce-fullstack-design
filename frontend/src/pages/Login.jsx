    ...
    <main className="bg-slate-100 px-4 py-10">
      <section className="mx-auto max-w-md rounded-md border border-slate-200 bg-white p-6">
        ...
        <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
          ...
          <input className="w-full rounded-md border border-slate-200 px-4 py-3 text-sm" name="password" placeholder="Password" required type="password" value={form.password} onChange={handleChange} />
